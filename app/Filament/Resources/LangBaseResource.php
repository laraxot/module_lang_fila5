...
use Illuminate\Support\Facades\Config; // Temporaneamente commentato per compatibilità Filament 5.x
use LaraZeus\SpatieTranslatable\Resources\Concerns\Translatable;
use Modules\Xot\Filament\Resources\XotBaseResource;

abstract class LangBaseResource extends XotBaseResource
{
    use Translatable; // Temporaneamente commentato per compatibilità Filament 5.x
