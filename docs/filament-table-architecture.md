...
module: Lang
updated: 2026-09-01
qmd: "tabella filament resource table class getTableFilters XotBaseResourceTable HasXotTable list page lang"
---
...
```php
namespace Modules\Lang\Filament\Resources\FooResource\Tables;
