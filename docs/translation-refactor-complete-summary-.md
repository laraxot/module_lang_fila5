...
- `/Modules/User/docs/translation-city-field-refactor-archive-1.md` - Dettagli refactor modulo User
- `/Modules/<nome progetto>/docs/translation-refactor-summary.md` - Status modulo <nome progetto>
...
- [Refactor Modulo User](../Modules/User/docs/translation-city-field-refactor-archive-1.md)
- [Status Modulo <nome progetto>](../Modules/<nome progetto>/docs/translation-refactor-summary.md)
