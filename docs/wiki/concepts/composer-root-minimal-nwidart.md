...
Dipendenze del dominio **Lang** in `Modules/Lang/composer.json`. Il root `laravel/composer.json` resta skeleton come [<repo progetto>](https://github.com/laraxot/<repo progetto>/blob/dev/laravel/composer.json).
