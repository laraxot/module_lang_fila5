---
title: "On-Demand Pattern — Module Lang"
type: documentation
created: 2026-05-11
updated: 2026-05-11
...
| Ricerca locale | `qmd search "topic" -c lang` |
| Wiki locale | `Read ./laravel/Modules/Lang/docs/wiki/index.md` |
...
3. **Mantieni la wiki aggiornata** — Dopo ogni task, aggiorna ./laravel/Modules/Lang/docs/wiki/log.md
