...
> Maturita' stimata: 68% implementato, 32% gap residuo.

## Visione di avanzamento

Questo roadmap traduce il PRD in sequenza di rilascio per **Lang**, che nel progetto copre: traduzioni, localizzazione e convenzioni lingua.
