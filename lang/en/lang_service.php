...
return [
    'fields' => [
        ...
        'current_team_id' => [
            ...
            'placeholder' => 'current_team_id',
            'helper_text' => 'current_team_id',
            'description' => 'current_team_id',
        ],
        'is_active' => [
            'label' => 'is_active',
        ...
        'password_expires_at' => [
            ...
            'placeholder' => 'password_expires_at',
            'helper_text' => 'password_expires_at',
            'description' => 'password_expires_at',
        ],
        'email_verified_at' => [
        ...
        'mobile_id' => [
            ...
            'helper_text' => 'mobile_id',
            'description' => 'mobile_id',
        ],
        'languages' => [
            'label' => 'languages',
            'placeholder' => 'languages',
            'helper_text' => 'languages',
        ...
        'is_robot' => [
            'label' => 'is_robot',
            'placeholder' => 'is_robot',
            'helper_text' => 'is_robot',
            'description' => 'is_robot',
        ],
        'robot' => [
            'label' => 'robot',
            'placeholder' => 'robot',
        ...
        'is_desktop' => [
            'label' => 'is_desktop',
            'placeholder' => 'is_desktop',
            'helper_text' => 'is_desktop',
            'description' => 'is_desktop',
        ],
        'is_mobile' => [
            'label' => 'is_mobile',
            'placeholder' => 'is_mobile',
            'helper_text' => 'is_mobile',
            'description' => 'is_mobile',
        ],
        'is_tablet' => [
            'label' => 'is_tablet',
            'placeholder' => 'is_tablet',
            'helper_text' => 'is_tablet',
            'description' => 'is_tablet',
        ],
        'is_phone' => [
            'label' => 'is_phone',
            'placeholder' => 'is_phone',
            'helper_text' => 'is_phone',
            'description' => 'is_phone',
        ],
        'active' => [
            'label' => 'active',
            'placeholder' => 'active',
        ...
        'personal_access_client' => [
            ...
            'helper_text' => 'personal_access_client',
            'description' => 'personal_access_client',
        ],
        'password_client' => [
            'label' => 'password_client',
            'placeholder' => 'password_client',
            'helper_text' => 'password_client',
            'description' => 'password_client',
        ],
        'access_token_id' => [
            'label' => 'access_token_id',
            'placeholder' => 'access_token_id',
            'helper_text' => 'access_token_id',
            'description' => 'access_token_id',
        ],
        'expires_at' => [
            'label' => 'expires_at',
        ...
        'provider_id' => [
            ...
            'helper_text' => 'provider_id',
            'description' => 'provider_id',
        ],
        'provider_token' => [
            'label' => 'provider_token',
            'placeholder' => 'provider_token',
            'helper_text' => 'provider_token',
            'description' => 'provider_token',
        ],
        'provider_refresh_token' => [
            'label' => 'provider_refresh_token',
            'placeholder' => 'provider_refresh_token',
            'helper_text' => 'provider_refresh_token',
            'description' => 'provider_refresh_token',
        ],
        'provider_avatar' => [
            'label' => 'provider_avatar',
            'placeholder' => 'provider_avatar',
            'helper_text' => 'provider_avatar',
            'description' => 'provider_avatar',
        ],
        'display_name' => [
            'label' => 'display_name',
        ...
        'test' => [
            'afternoon_from' => [
                'placeholder' => 'test.afternoon_from',
                'helper_text' => 'test.afternoon_from',
                'description' => 'test.afternoon_from',
                'label' => 'test.afternoon_from',
            ],
            'label' => 'test',
            'placeholder' => 'test',
            'morning_from' => [
                'label' => 'test.morning_from',
                'placeholder' => 'test.morning_from',
                'helper_text' => 'test.morning_from',
                'description' => 'test.morning_from',
            ],
            'morning_to' => [
                'label' => 'test.morning_to',
                'placeholder' => 'test.morning_to',
                'helper_text' => 'test.morning_to',
                'description' => 'test.morning_to',
            ],
            'afternoon_to' => [
                'label' => 'test.afternoon_to',
                'placeholder' => 'test.afternoon_to',
                'helper_text' => 'test.afternoon_to',
                'description' => 'test.afternoon_to',
            ],
            'helper_text' => 'test',
            'description' => 'test',
        ],
        ...
        'user_code' => [
            ...
            'helper_text' => 'user_code',
            'description' => 'user_code',
        ],
        'user_approved_at' => [
            'label' => 'user_approved_at',
            'placeholder' => 'user_approved_at',
            'helper_text' => 'user_approved_at',
            'description' => 'user_approved_at',
        ],
        'last_polled_at' => [
            'label' => 'last_polled_at',
            'placeholder' => 'last_polled_at',
            'helper_text' => 'last_polled_at',
            'description' => 'last_polled_at',
        ],
        'background_color' => [
        ...
        'otp_expiration_minutes' => [
            'label' => 'otp_expiration_minutes',
            'placeholder' => 'otp_expiration_minutes',
            'helper_text' => 'otp_expiration_minutes',
            'description' => 'otp_expiration_minutes',
        ],
        'otp_length' => [
            'label' => 'otp_length',
            'placeholder' => 'otp_length',
            'helper_text' => 'otp_length',
            'description' => 'otp_length',
        ],
        'expires_in' => [
            'label' => 'expires_in',
            'placeholder' => 'expires_in',
            'helper_text' => 'expires_in',
        ...
        'uncompromised' => [
            ...
            'helper_text' => 'uncompromised',
            'description' => 'uncompromised',
        ],
        'compromisedThreshold' => [
            'label' => 'compromisedThreshold',
            'placeholder' => 'compromisedThreshold',
            'helper_text' => 'compromisedThreshold',
            'description' => 'compromisedThreshold',
        ],
        'google' => [
            'enabled' => [
                'label' => 'google.enabled',
                'placeholder' => 'google.enabled',
                'helper_text' => 'google.enabled',
                'description' => 'google.enabled',
            ],
            'client_id' => [
                'label' => 'google.client_id',
                'placeholder' => 'google.client_id',
                'helper_text' => 'google.client_id',
                'description' => 'google.client_id',
            ],
            'client_secret' => [
                'label' => 'google.client_secret',
                'placeholder' => 'google.client_secret',
                'helper_text' => 'google.client_secret',
                'description' => 'google.client_secret',
            ],
            'scopes' => [
                'label' => 'google.scopes',
                'placeholder' => 'google.scopes',
                'helper_text' => 'google.scopes',
                'description' => 'google.scopes',
            ],
            'redirect' => [
                'label' => 'google.redirect',
                'placeholder' => 'google.redirect',
                'helper_text' => 'google.redirect',
        ...
        'github' => [
            'enabled' => [
                ...
                'placeholder' => 'github.enabled',
                'helper_text' => 'github.enabled',
                'description' => 'github.enabled',
            ],
            'client_id' => [
                'label' => 'github.client_id',
                'placeholder' => 'github.client_id',
                'helper_text' => 'github.client_id',
                'description' => 'github.client_id',
            ],
            'client_secret' => [
                'label' => 'github.client_secret',
                'placeholder' => 'github.client_secret',
                'helper_text' => 'github.client_secret',
                'description' => 'github.client_secret',
            ],
            'scopes' => [
                'label' => 'github.scopes',
                'placeholder' => 'github.scopes',
                'helper_text' => 'github.scopes',
                'description' => 'github.scopes',
            ],
            'redirect' => [
                'label' => 'github.redirect',
                'placeholder' => 'github.redirect',
                'helper_text' => 'github.redirect',
                'description' => 'github.redirect',
            ],
        ],
        'microsoft' => [
            'enabled' => [
                'label' => 'microsoft.enabled',
                'placeholder' => 'microsoft.enabled',
                'helper_text' => 'microsoft.enabled',
                'description' => 'microsoft.enabled',
            ],
            'client_id' => [
                'label' => 'microsoft.client_id',
                'placeholder' => 'microsoft.client_id',
                'helper_text' => 'microsoft.client_id',
                'description' => 'microsoft.client_id',
            ],
            'client_secret' => [
                'label' => 'microsoft.client_secret',
                'placeholder' => 'microsoft.client_secret',
                'helper_text' => 'microsoft.client_secret',
                'description' => 'microsoft.client_secret',
            ],
            'scopes' => [
                'label' => 'microsoft.scopes',
                'placeholder' => 'microsoft.scopes',
                'helper_text' => 'microsoft.scopes',
                'description' => 'microsoft.scopes',
            ],
            'redirect' => [
                'label' => 'microsoft.redirect',
                'placeholder' => 'microsoft.redirect',
                'helper_text' => 'microsoft.redirect',
                'description' => 'microsoft.redirect',
            ],
        ],
        'authenticatable' => [
            'name' => [
        ...
        'master_admin' => [
            ...
            'helper_text' => 'master_admin',
            'description' => 'master_admin',
        ],
        'backoffice_user' => [
            'label' => 'backoffice_user',
            'placeholder' => 'backoffice_user',
            'helper_text' => 'backoffice_user',
            'description' => 'backoffice_user',
        ],
        'customer_user' => [
            'label' => 'customer_user',
            'placeholder' => 'customer_user',
            'helper_text' => 'customer_user',
        ...
        'NOT LIKE' => [
            ...
            'helper_text' => 'NOT LIKE',
            'description' => 'NOT LIKE',
        ],
        'min_gg_posiz_1_in_sede' => [
            'label' => 'min_gg_posiz_1_in_sede',
            'placeholder' => 'min_gg_posiz_1_in_sede',
            'helper_text' => 'min_gg_posiz_1_in_sede',
            'description' => 'min_gg_posiz_1_in_sede',
        ],
        'min_gg_propro' => [
            'label' => 'min_gg_propro',
            'placeholder' => 'min_gg_propro',
            'helper_text' => 'min_gg_propro',
            'description' => 'min_gg_propro',
        ],
        'min_gg_propro_posfun' => [
            'label' => 'min_gg_propro_posfun',
            'placeholder' => 'min_gg_propro_posfun',
            'helper_text' => 'min_gg_propro_posfun',
            'description' => 'min_gg_propro_posfun',
        ],
        'min_gg_cateco_posfun_lavorati_in_sede' => [
            'label' => 'min_gg_cateco_posfun_lavorati_in_sede',
            'placeholder' => 'min_gg_cateco_posfun_lavorati_in_sede',
            'helper_text' => 'min_gg_cateco_posfun_lavorati_in_sede',
            'description' => 'min_gg_cateco_posfun_lavorati_in_sede',
        ],
        'min_gg_anno' => [
            'label' => 'min_gg_anno',
            'placeholder' => 'min_gg_anno',
            'helper_text' => 'min_gg_anno',
            'description' => 'min_gg_anno',
        ],
        'lista_propro_posfun' => [
            'label' => 'lista_propro_posfun',
            'placeholder' => 'lista_propro_posfun',
            'helper_text' => 'lista_propro_posfun',
            'description' => 'lista_propro_posfun',
        ],
        'lista_propro' => [
            'label' => 'lista_propro',
        ...
        'lista_posiz' => [
            'placeholder' => 'lista_posiz',
            'helper_text' => 'lista_posiz',
            'description' => 'lista_posiz',
            'label' => 'lista_posiz',
        ],
        'disci' => [
            'label' => 'disci',
        ...
        'lista_asz_tip_cod_escluso_subito' => [
            'label' => 'lista_asz_tip_cod_escluso_subito',
            'placeholder' => 'lista_asz_tip_cod_escluso_subito',
            'helper_text' => 'lista_asz_tip_cod_escluso_subito',
            'description' => 'lista_asz_tip_cod_escluso_subito',
        ],
        'presenti_il_giorno' => [
            'label' => 'presenti_il_giorno',
            'placeholder' => 'presenti_il_giorno',
            'helper_text' => 'presenti_il_giorno',
            'description' => 'presenti_il_giorno',
        ],
        'min_gg_cateco_posfun_in_sede_no_asz' => [
            'label' => 'min_gg_cateco_posfun_in_sede_no_asz',
            'placeholder' => 'min_gg_cateco_posfun_in_sede_no_asz',
            'helper_text' => 'min_gg_cateco_posfun_in_sede_no_asz',
            'description' => 'min_gg_cateco_posfun_in_sede_no_asz',
        ],
        'propro' => [
            'label' => 'propro',
            'placeholder' => 'propro',
        ...
        'min_gg_integ_params' => [
            'label' => 'min_gg_integ_params',
            'placeholder' => 'min_gg_integ_params',
            'helper_text' => 'min_gg_integ_params',
            'description' => 'min_gg_integ_params',
        ],
        'min_gg_integ_params_no_asz' => [
            'label' => 'min_gg_integ_params_no_asz',
            'placeholder' => 'min_gg_integ_params_no_asz',
            'helper_text' => 'min_gg_integ_params_no_asz',
            'description' => 'min_gg_integ_params_no_asz',
        ],
        'stabi' => [
            'label' => 'stabi',
            'placeholder' => 'stabi',
        ...
        'top-left' => [
            ...
            'helper_text' => 'top-left',
            'description' => 'top-left',
        ],
        'top-right' => [
            'label' => 'top-right',
            'placeholder' => 'top-right',
            'helper_text' => 'top-right',
            'description' => 'top-right',
        ],
        'bottom-left' => [
            'label' => 'bottom-left',
            'placeholder' => 'bottom-left',
            'helper_text' => 'bottom-left',
            'description' => 'bottom-left',
        ],
        'bottom-right' => [
            'label' => 'bottom-right',
            'placeholder' => 'bottom-right',
            'helper_text' => 'bottom-right',
        ...
        'keywords' => [
            ...
            'helper_text' => 'keywords',
            'description' => 'keywords',
        ],
        'logo_header' => [
            'label' => 'logo_header',
            'placeholder' => 'logo_header',
            'helper_text' => 'logo_header',
            'description' => 'logo_header',
        ],
        'logo_header_dark' => [
            'label' => 'logo_header_dark',
            'placeholder' => 'logo_header_dark',
            'helper_text' => 'logo_header_dark',
            'description' => 'logo_header_dark',
        ],
        'colors' => [
            'label' => 'colors',
            'placeholder' => 'colors',
        ...
        'parse_mode' => [
            'label' => 'parse_mode',
            'placeholder' => 'parse_mode',
            'helper_text' => 'parse_mode',
            'description' => 'parse_mode',
        ],
        'disable_web_page_preview' => [
            'label' => 'disable_web_page_preview',
            'placeholder' => 'disable_web_page_preview',
            'helper_text' => 'disable_web_page_preview',
            'description' => 'disable_web_page_preview',
        ],
        'disable_notification' => [
            'label' => 'disable_notification',
            'placeholder' => 'disable_notification',
            'helper_text' => 'disable_notification',
            'description' => 'disable_notification',
        ],
        'reply_to_message_id' => [
            'label' => 'reply_to_message_id',
            'placeholder' => 'reply_to_message_id',
            'helper_text' => 'reply_to_message_id',
            'description' => 'reply_to_message_id',
        ],
        'media_url' => [
            'label' => 'media_url',
        ...
        'smsfactor' => [
            'label' => 'smsfactor',
            'placeholder' => 'smsfactor',
            'helper_text' => 'smsfactor',
            'description' => 'smsfactor',
        ],
        'hours' => [
            'label' => 'hours',
            'placeholder' => 'hours',
        ...
        'laravel-telegram' => [
            ...
            'placeholder' => 'laravel-telegram',
            'helper_text' => 'laravel-telegram',
        ...
        'custom_doc' => [
            ...
            'helper_text' => 'custom_doc',
            'description' => 'custom_doc',
        ],
        'no' => [
            'label' => 'no',
            'placeholder' => 'no',
        ...
        'collection' => [
            ...
            'helper_text' => 'collection',
            'description' => 'collection',
        ],
        'select_state' => [
            'label' => 'select_state',
            'placeholder' => 'select_state',
            'helper_text' => 'select_state',
        ...
        'options_with_value' => [
            'label' => 'options_with_value',
            'placeholder' => 'options_with_value',
            'helper_text' => 'options_with_value',
            'description' => 'options_with_value',
        ],
        'expression' => [
            'label' => 'expression',
            'placeholder' => 'expression',
            'helper_text' => 'expression',
            'description' => 'expression',
        ],
        'environments' => [
            'label' => 'environments',
            'placeholder' => 'environments',
            'helper_text' => 'environments',
            'description' => 'environments',
        ],
        'log_filename' => [
            'label' => 'log_filename',
            'placeholder' => 'log_filename',
            'helper_text' => 'log_filename',
            'description' => 'log_filename',
        ],
        'webhook_before' => [
            'label' => 'webhook_before',
            'placeholder' => 'webhook_before',
            'helper_text' => 'webhook_before',
            'description' => 'webhook_before',
        ],
        'webhook_after' => [
            'label' => 'webhook_after',
            'placeholder' => 'webhook_after',
            'helper_text' => 'webhook_after',
            'description' => 'webhook_after',
        ],
        'email_output' => [
            'label' => 'email_output',
            'placeholder' => 'email_output',
            'helper_text' => 'email_output',
            'description' => 'email_output',
        ],
        'sendmail_success' => [
            'label' => 'sendmail_success',
            'placeholder' => 'sendmail_success',
            'helper_text' => 'sendmail_success',
            'description' => 'sendmail_success',
        ],
        'sendmail_error' => [
            'label' => 'sendmail_error',
            'placeholder' => 'sendmail_error',
            'helper_text' => 'sendmail_error',
            'description' => 'sendmail_error',
        ],
        'log_success' => [
            'label' => 'log_success',
            'placeholder' => 'log_success',
            'helper_text' => 'log_success',
            'description' => 'log_success',
        ],
        'log_error' => [
            'label' => 'log_error',
            'placeholder' => 'log_error',
            'helper_text' => 'log_error',
            'description' => 'log_error',
        ],
        'even_in_maintenance_mode' => [
            'label' => 'even_in_maintenance_mode',
            'placeholder' => 'even_in_maintenance_mode',
            'helper_text' => 'even_in_maintenance_mode',
            'description' => 'even_in_maintenance_mode',
        ],
        'without_overlapping' => [
            'label' => 'without_overlapping',
            'placeholder' => 'without_overlapping',
            'helper_text' => 'without_overlapping',
            'description' => 'without_overlapping',
        ],
        'on_one_server' => [
            'label' => 'on_one_server',
            'placeholder' => 'on_one_server',
            'helper_text' => 'on_one_server',
            'description' => 'on_one_server',
        ],
        'run_in_background' => [
            'label' => 'run_in_background',
            'placeholder' => 'run_in_background',
            'helper_text' => 'run_in_background',
        ...
        'categoria' => [
            ...
            'helper_text' => 'categoria',
            'description' => 'categoria',
        ],
        'lista_propro_sup' => [
            'label' => 'lista_propro_sup',
            'placeholder' => 'lista_propro_sup',
            'helper_text' => 'lista_propro_sup',
            'description' => 'lista_propro_sup',
        ],
        'posti' => [
            'label' => 'posti',
            'placeholder' => 'posti',
        ...
        'header_row' => [
            'label' => 'header_row',
            'placeholder' => 'header_row',
            'helper_text' => 'header_row',
            'description' => 'header_row',
        ],
        'code_txt' => [
            'label' => 'code_txt',
            'placeholder' => 'code_txt',
            'helper_text' => 'code_txt',
        ...
        'stabi_diri_id' => [
            'label' => 'stabi_diri_id',
            'placeholder' => 'stabi_diri_id',
            'helper_text' => 'stabi_diri_id',
            'description' => 'stabi_diri_id',
        ],
        'asztip' => [
            'label' => 'asztip',
            'placeholder' => 'asztip',
        ...
        'valutatore' => [
            ...
            'anno' => [
                'label' => 'valutatore.anno',
            ],
            'quadrimestre' => [
                'label' => 'valutatore.quadrimestre',
            ],
        ],
        'attivo' => [
            'label' => 'attivo',
        ...
        'order_direction' => [
            ...
            'placeholder' => 'order_direction',
            'helper_text' => 'order_direction',
            'description' => 'order_direction',
        ],
        'posizione' => [
            'label' => 'posizione',
            'placeholder' => 'posizione',
            'helper_text' => 'posizione',
        ...
        'max_gg_tot_pond' => [
            ...
            'placeholder' => 'max_gg_tot_pond',
            'helper_text' => 'max_gg_tot_pond',
            'description' => 'max_gg_tot_pond',
        ],
        'aventi_diritto' => [
            'label' => 'aventi_diritto',
            'placeholder' => 'aventi_diritto',
            'helper_text' => 'aventi_diritto',
            'description' => 'aventi_diritto',
        ],
        'aventi_diritto_perc' => [
            'label' => 'aventi_diritto_perc',
            'placeholder' => 'aventi_diritto_perc',
            'helper_text' => 'aventi_diritto_perc',
            'description' => 'aventi_diritto_perc',
        ],
        'aventi_diritto_eff' => [
            'label' => 'aventi_diritto_eff',
            'placeholder' => 'aventi_diritto_eff',
            'helper_text' => 'aventi_diritto_eff',
            'description' => 'aventi_diritto_eff',
        ],
        'id_approvaz' => [
            'label' => 'id_approvaz',
            'placeholder' => 'id_approvaz',
            'helper_text' => 'id_approvaz',
            'description' => 'id_approvaz',
        ],
        'datemod' => [
            'label' => 'datemod',
            'placeholder' => 'datemod',
        ...
        'is_editable' => [
            'label' => 'is_editable',
            'placeholder' => 'is_editable',
            'helper_text' => 'is_editable',
            'description' => 'is_editable',
        ],
        'converted_in' => [
            'label' => 'converted_in',
            'placeholder' => 'converted_in',
            'helper_text' => 'converted_in',
        ...
        'posizione_funzionale' => [
            'label' => 'posizione_funzionale',
        ],
        'descr_posizione_funzionale' => [
            'label' => 'descr_posizione_funzionale',
        ],
        'stabilimento' => [
            'label' => 'stabilimento',
        ],
        ...
        'notify::filament' => [
            'components' => [
                'params-badges' => [
                    'label' => 'notify::filament.components.params-badges',
                ],
            ],
        ],
        'azioni' => [
        ...
        'gg_cateco_posfun_no_asz_in_sede' => [
            'label' => 'gg_cateco_posfun_no_asz_in_sede',
        ],
        'gg_cateco_posfun_no_asz_fuori_sede' => [
            'label' => 'gg_cateco_posfun_no_asz_fuori_sede',
        ],
        'send-mail' => [
            'label' => 'send-mail',
        ],
        ...
        's3_results' => [
            'placeholder' => 's3_results',
            'helper_text' => 's3_results',
            'description' => 's3_results',
            'label' => 's3_results',
        ],
        'cloudfront_url' => [
            'label' => 'cloudfront_url',
            'placeholder' => 'cloudfront_url',
            'helper_text' => 'cloudfront_url',
            'description' => 'cloudfront_url',
        ],
        'cloudfront_results' => [
            'placeholder' => 'cloudfront_results',
            'helper_text' => 'cloudfront_results',
            'description' => 'cloudfront_results',
            'label' => 'cloudfront_results',
        ],
        'ricerca' => [
            'label' => 'ricerca',
        ],
        ...
        'fileRealPath' => [
            'label' => 'fileRealPath',
            'placeholder' => 'fileRealPath',
            'helper_text' => 'fileRealPath',
            'description' => 'fileRealPath',
        ],
        'create_table' => [
            'label' => 'create_table',
            'placeholder' => 'create_table',
            'helper_text' => 'create_table',
        ...
        'min_gg_cateco_posfun_no_asz' => [
            'label' => 'min_gg_cateco_posfun_no_asz',
            'placeholder' => 'min_gg_cateco_posfun_no_asz',
            'helper_text' => 'min_gg_cateco_posfun_no_asz',
            'description' => 'min_gg_cateco_posfun_no_asz',
        ],
        'min_gg_esperienza_no_asz' => [
            'label' => 'min_gg_esperienza_no_asz',
            'placeholder' => 'min_gg_esperienza_no_asz',
            'helper_text' => 'min_gg_esperienza_no_asz',
            'description' => 'min_gg_esperienza_no_asz',
        ],
        'string' => [
            'label' => 'string',
            'placeholder' => 'string',
        ...
        'iam_user' => [
            'label' => 'iam_user',
            'placeholder' => 'iam_user',
            'helper_text' => 'iam_user',
            'description' => 'iam_user',
        ],
        'iam_results' => [
            'label' => 'iam_results',
            'placeholder' => 'iam_results',
            'helper_text' => 'iam_results',
            'description' => 'iam_results',
        ],
        'full_results' => [
            'label' => 'full_results',
            'placeholder' => 'full_results',
            'helper_text' => 'full_results',
            'description' => 'full_results',
        ],
        'aws_config' => [
            'label' => 'aws_config',
            'placeholder' => 'aws_config',
            'helper_text' => 'aws_config',
            'description' => 'aws_config',
        ],
        'pending-icon' => [
            'label' => 'pending-icon',
        ],
        ...
        'records_preview' => [
            'label' => 'records_preview',
            'placeholder' => 'records_preview',
            'helper_text' => 'records_preview',
            'description' => 'records_preview',
        ],
        'perf_ind_0' => [
            'label' => 'perf_ind_0',
        ],
        ...
        'gg_asz_cateco_posfun' => [
            'label' => 'gg_asz_cateco_posfun',
        ],
        'badge' => [
            'label' => 'badge',
            'placeholder' => 'badge',
        ...
        'nested_field' => [
            'label' => 'nested_field',
            'placeholder' => 'nested_field',
            'helper_text' => 'nested_field',
            'description' => 'nested_field',
        ],
        'flat_field' => [
            'label' => 'flat_field',
            'placeholder' => 'flat_field',
            'helper_text' => 'flat_field',
            'description' => 'flat_field',
        ],
        'fromBreakpoint' => [
            'label' => 'fromBreakpoint',
            'placeholder' => 'fromBreakpoint',
            'helper_text' => 'fromBreakpoint',
            'description' => 'fromBreakpoint',
        ],
        'isAsymmetric' => [
            'label' => 'isAsymmetric',
            'placeholder' => 'isAsymmetric',
            'helper_text' => 'isAsymmetric',
        ...
        'startSpan' => [
            'label' => 'startSpan',
            'placeholder' => 'startSpan',
            'helper_text' => 'startSpan',
            'description' => 'startSpan',
        ],
        'endSpan' => [
            'label' => 'endSpan',
            'placeholder' => 'endSpan',
        ...
        'shouldOpenInNewTab' => [
            'label' => 'shouldOpenInNewTab',
            'placeholder' => 'shouldOpenInNewTab',
            'helper_text' => 'shouldOpenInNewTab',
            'description' => 'shouldOpenInNewTab',
        ],
    ...
    'actions' => [
        ...
        'revoke_all_for_user' => [
            'label' => 'revoke_all_for_user',
            'icon' => 'revoke_all_for_user',
            'tooltip' => 'revoke_all_for_user',
        ],
        'copy_from_last_year' => [
            'label' => 'copy_from_last_year',
        ...
        'field_refresh' => [
            'label' => 'field_refresh',
            'icon' => 'field_refresh',
            'tooltip' => 'field_refresh',
        ],
        'artisan_action' => [
            'label' => 'artisan_action',
            'icon' => 'artisan_action',
            'tooltip' => 'artisan_action',
        ],
        'fake_seeder' => [
            'label' => 'fake_seeder',
            'tooltip' => 'fake_seeder',
        ...
        'sanitize-fields-header' => [
            'label' => 'sanitize-fields-header',
            'icon' => 'sanitize-fields-header',
            'tooltip' => 'sanitize-fields-header',
        ],
        'layout' => [
            'label' => 'layout',
            'icon' => 'layout',
        ...
        'sendPushNotification' => [
            ...
            'icon' => 'sendPushNotification',
            'tooltip' => 'sendPushNotification',
        ],
        'sendSms' => [
            'label' => 'sendSms',
            'icon' => 'sendSms',
        ...
        'telegramFormActions' => [
            'label' => 'telegramFormActions',
            'icon' => 'telegramFormActions',
            'tooltip' => 'telegramFormActions',
        ],
        'whatsappFormActions' => [
        ...
        'testConnection' => [
            ...
            'icon' => 'testConnection',
            'tooltip' => 'testConnection',
        ],
        'clearResults' => [
            'label' => 'clearResults',
            'icon' => 'clearResults',
            'tooltip' => 'clearResults',
        ],
        'replicate' => [
            'label' => 'replicate',
            'icon' => 'replicate',
        ...
        'testCredentials' => [
            ...
            'icon' => 'testCredentials',
            'tooltip' => 'testCredentials',
        ],
        'testS3Connection' => [
            'label' => 'testS3Connection',
            'icon' => 'testS3Connection',
            'tooltip' => 'testS3Connection',
        ],
        'testPermissions' => [
            'label' => 'testPermissions',
            'icon' => 'testPermissions',
            'tooltip' => 'testPermissions',
        ],
        'testBucketPolicy' => [
            'label' => 'testBucketPolicy',
            'icon' => 'testBucketPolicy',
            'tooltip' => 'testBucketPolicy',
        ],
        'testCloudFront' => [
            'label' => 'testCloudFront',
            'icon' => 'testCloudFront',
            'tooltip' => 'testCloudFront',
        ],
        'testFileOperations' => [
            'label' => 'testFileOperations',
            'icon' => 'testFileOperations',
            'tooltip' => 'testFileOperations',
        ],
        'test01' => [
            'label' => 'test01',
            'icon' => 'test01',
        ...
        'test_s3_connection' => [
            'label' => 'test_s3_connection',
            'icon' => 'test_s3_connection',
            'tooltip' => 'test_s3_connection',
        ],
        'test_cloudfront_config' => [
            'label' => 'test_cloudfront_config',
            'icon' => 'test_cloudfront_config',
            'tooltip' => 'test_cloudfront_config',
        ],
        'view_attachment' => [
            'label' => 'view_attachment',
            'icon' => 'view_attachment',
            'tooltip' => 'view_attachment',
        ],
        'download_attachment' => [
            'label' => 'download_attachment',
            'icon' => 'download_attachment',
            'tooltip' => 'download_attachment',
        ],
        'downloadExample' => [
        ...
        'copyFromLastYear' => [
            'label' => 'copyFromLastYear',
            'icon' => 'copyFromLastYear',
            'tooltip' => 'copyFromLastYear',
        ],
        'convert' => [
            'label' => 'convert',
            'icon' => 'convert',
        ...
        'test_s3_permissions' => [
            'label' => 'test_s3_permissions',
            'icon' => 'test_s3_permissions',
            'tooltip' => 'test_s3_permissions',
        ],
        'test_file_operations' => [
            'label' => 'test_file_operations',
            'icon' => 'test_file_operations',
            'tooltip' => 'test_file_operations',
        ],
        'test_signed_urls' => [
            'label' => 'test_signed_urls',
            'icon' => 'test_signed_urls',
            'tooltip' => 'test_signed_urls',
        ],
        'test_iam_credentials' => [
            'label' => 'test_iam_credentials',
            'icon' => 'test_iam_credentials',
            'tooltip' => 'test_iam_credentials',
        ],
        'test_iam_policies' => [
            'label' => 'test_iam_policies',
            'icon' => 'test_iam_policies',
            'tooltip' => 'test_iam_policies',
        ],
        'run_full_diagnostic' => [
            'label' => 'run_full_diagnostic',
            'icon' => 'run_full_diagnostic',
            'tooltip' => 'run_full_diagnostic',
        ],
        'add_attachment' => [
            'label' => 'add_attachment',
            'icon' => 'add_attachment',
            'tooltip' => 'add_attachment',
        ],
        'pending-action' => [
        ...
        'ricalcolaDiritto' => [
            'label' => 'ricalcolaDiritto',
            'icon' => 'ricalcolaDiritto',
            'tooltip' => 'ricalcolaDiritto',
        ],
        'export_xls_lazy_cov' => [
            'label' => 'export_xls_lazy_cov',
            'icon' => 'export_xls_lazy_cov',
            'tooltip' => 'export_xls_lazy_cov',
        ],
        'export_xls_cov' => [
            'label' => 'export_xls_cov',
            'icon' => 'export_xls_cov',
            'tooltip' => 'export_xls_cov',
        ],
        'MakePdfAction' => [
            'label' => 'MakePdfAction',
            'icon' => 'MakePdfAction',
        ...
        'import_ced_diff' => [
            'label' => 'import_ced_diff',
            'icon' => 'import_ced_diff',
            'tooltip' => 'import_ced_diff',
        ],
        ...
        'fill_out_the_form' => [
            'label' => 'fill_out_the_form',
            'icon' => 'fill_out_the_form',
            'tooltip' => 'fill_out_the_form',
        ],
        'record_pdf' => [
            'label' => 'record_pdf',
            'icon' => 'record_pdf',
        ...
        'associateAnother' => [
            'label' => 'associateAnother',
            'icon' => 'associateAnother',
    ...
    'sections' => [
        ...
        'Codice Autorizzazione OAuth' => [
            'label' => 'Codice Autorizzazione OAuth',
            'heading' => 'Codice Autorizzazione OAuth',
        ],
        'Codice Dispositivo OAuth' => [
            'label' => 'Codice Dispositivo OAuth',
            'heading' => 'Codice Dispositivo OAuth',
        ],
        'Refresh Token OAuth' => [
            'label' => 'Refresh Token OAuth',
            'heading' => 'Refresh Token OAuth',
        ],
        'User Information' => [
        ...
        'GitHub OAuth' => [
            'label' => 'GitHub OAuth',
            'heading' => 'GitHub OAuth',
        ],
        'Microsoft OAuth' => [
            'label' => 'Microsoft OAuth',
            'heading' => 'Microsoft OAuth',
        ],
        ...
        'Dati Aggiuntivi' => [
            ...
            'heading' => 'Dati Aggiuntivi',
        ],
        'Informazioni di Sistema' => [
            'label' => 'Informazioni di Sistema',
            'heading' => 'Informazioni di Sistema',
        ],
        'Dati Anagrafici' => [
        ...
        'criteri_esclusione' => [
            'label' => 'criteri_esclusione',
            'heading' => 'criteri_esclusione',
        ],
        'S3 Connection Test' => [
            'label' => 'S3 Connection Test',
            'heading' => 'S3 Connection Test',
        ],
        'CloudFront Test' => [
            'label' => 'CloudFront Test',
            'heading' => 'CloudFront Test',
        ],
        'IAM Permissions Test' => [
            'label' => 'IAM Permissions Test',
            'heading' => 'IAM Permissions Test',
        ],
        'Complete Diagnostic' => [
            'label' => 'Complete Diagnostic',
            'heading' => 'Complete Diagnostic',
        ],
        'Criteri Valutazione' => [
            'label' => 'Criteri Valutazione',
            'heading' => 'Criteri Valutazione',
        ],
        'gruppo' => [
            'label' => 'gruppo',
            'heading' => 'gruppo',
