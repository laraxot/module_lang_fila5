...
return [
    'actions' => [
        'create' => ['label' => 'Crea', 'tooltip' => 'Crea nuovo file di traduzione', 'success' => 'File di traduzione creato con successo'],
        'lang' => ['label' => 'Lingua', 'tooltip' => 'Seleziona lingua'],
    ],
    'fields' => [
        ...
        'content' => ['description' => 'Contenuto del file di traduzione', 'helper_text' => '', 'placeholder' => 'Inserisci contenuto traduzione', 'label' => 'Contenuto', 'tooltip' => ''],
